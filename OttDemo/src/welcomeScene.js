...
//        loading.setPosition(cc.p(size.width/2.5, size.height/2));
        loading.setPosition(cc.p(size.width-loading.getContentSize().width, loading.getContentSize().height/2));
...
//        armature.setPosition(cc.p(size.width/3, size.height/2));
        armature.setPosition(cc.p(size.width-loading.getContentSize().width-armature.getContentSize().width,loading.getContentSize().height/2));
        layer.addChild(armature);
        layer.addWidget(loading);

        this.addChild(layer);

        this.scheduleOnce(this.replaceScene,1.0);
